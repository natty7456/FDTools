<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="FDTools.Pages.WebForm1" %>
...
<head runat="server">
    ...
    <link rel="stylesheet" href="/Resource/matrix-admin/css/bootstrap-wysihtml5.css" />
...
<body>
                            ...
                            <form action="#" class="form-horizontal">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        ...
                                        <span class="help-block blue span8">(999) 999-9999? x99999</span>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label for="normal" class="control-label">Phone field + ext.</label>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        ...
                                        <span class="help-block blue span8">a*-999-a999</span>
                                    </div>
                                </div>
                                <div class="control-group">
    ...
    <script src="/Resource/matrix-admin/js/matrix.form_common.js"></script>
    <script src="/Resource/matrix-admin/js/wysihtml5-0.3.0.js"></script>
    <script src="/Resource/matrix-admin/js/jquery.peity.min.js"></script>
    <script src="/Resource/matrix-admin/js/bootstrap-wysihtml5.js"></script>
    <script>
